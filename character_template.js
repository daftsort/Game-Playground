...
$.getScript('rolls.js'), function () {
    // Functions necessary to build a character:
    ...
    var player_character = {
        ...
        dodge_chance: dex_bonus + level * d_four_roll, // Low chance, avoids a lot of damage.
        dodge_effect: (int_bonus + d_hundred_roll + 10 * level), // Should be a high percent avoided.
        block_chance: dex_bonus + level * d_twenty_roll, // Higher chance, damage mitigation - not avoidance.
        block_effect: (str_bonus * level * d_twenty_roll) / 100, // Percent of damage mitigated.
        ...
        attack_speed: dex_bonus * d_twenty_roll, // Determines turn order in combat.
        potion_rating: int_bonus * d_six_roll,
